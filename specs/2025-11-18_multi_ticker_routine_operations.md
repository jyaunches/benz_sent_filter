...
- Report per-ticker routine operations results in table format
...
```
MULTI-TICKER FILTER ACTIVATION REPORT
=====================================

1. "Major banks announce quarterly dividend payments"
   Tickers: BAC, JPM, C, WFC, GS

   Multi-Ticker Endpoint (3.2s):
     Core Classification: is_opinion=False, temporal=GENERAL_TOPIC
     BAC: routine=True, confidence=0.89
     JPM: routine=True, confidence=0.87
     C:   routine=True, confidence=0.85
     WFC: routine=True, confidence=0.91
     GS:  routine=True, confidence=0.83

   Sequential Single-Ticker (9.5s):
     BAC: 1.9s, routine=True, confidence=0.89
     JPM: 1.9s, routine=True, confidence=0.87
     C:   1.9s, routine=True, confidence=0.85
     WFC: 1.9s, routine=True, confidence=0.91
     GS:  1.9s, routine=True, confidence=0.83

   Time Savings: 6.3s (66% faster)
   Consistency: ✓ All routine scores match

SUMMARY:
- Total headlines tested: 5
- Average tickers per headline: 4.2
- Average time saved per headline: 5.8s (63%)
- Core classification consistency: 100%
- Per-ticker routine score consistency: 100%
```
